...
async function a0_0x270434(_0x91f67) {
  ...
  const _0xe02cc9 = (_0x366f3a, _0x550cff) => {
      console['log']('[:] ' + _0x366f3a, _0x550cff || '');
    },
...
function a0_0x427abb(_0x82a9c8, _0x40497b, _0x1a68c2) {
  const _0x29bbf6 = new ReadableStream({
    ...
    'pull'(_0x19ca1f) {},
    'cancel'(_0x415d9b) {
      _0x1a68c2('ReadableStream was canceled, due to ' + _0x415d9b), a0_0x767ee6(_0x82a9c8);
    }
  });
  return _0x29bbf6;
}
function a0_0x24e165(_0x3eb58c, _0x39ea57) {
  ...
  switch (_0x59f322) {
    case 0x1:
      _0x50ac00 = 0x4, _0x1a1ee = _0x1bb233 + 0x3, _0x3faa85 = new Uint8Array(_0x3eb58c['slice'](_0x1a1ee, _0x1a1ee + 0x4))['join']('.');
      break;
    case 0x2:
...
async function a0_0x27557f(_0x198b8b, _0x115bfe, _0x2b5d8d, _0x31a357, _0x383ff8) {
  try {
    await _0x198b8b['readable']['pipeTo'](new WritableStream({
      ...
      'close'() {
        _0x383ff8('Remote connection readable closed. Had incoming data: true');
      },
      'abort'(_0x3e317d) {
